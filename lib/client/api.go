...
func (tc *TeleportClient) localLogin(ctx context.Context, secondFactor string, pub []byte) (*server.SSHLoginResponse, error) {
	var err error
	var response *server.SSHLoginResponse
...
func (tc *TeleportClient) directLogin(ctx context.Context, secondFactorType string, pub []byte) (*server.SSHLoginResponse, error) {
	var err error
...
func (tc *TeleportClient) u2fLogin(ctx context.Context, pub []byte) (*server.SSHLoginResponse, error) {
	password, err := tc.AskPassword()
	if err != nil {
		return nil, trace.Wrap(err)
	}
