...
func (c *Client) GetU2FSignRequest(user string, password []byte) (*server.U2FAuthenticateChallenge, error) {
	out, err := c.PostJSON(
	...
	var signRequest *server.U2FAuthenticateChallenge
...
type clientIdentity interface {
	...
	// GetU2FSignRequest generates request for user trying to authenticate with U2F token
	GetU2FSignRequest(user string, password []byte) (*server.U2FAuthenticateChallenge, error)
