...
func (a *ServerWithRoles) GetNodes(namespace string, opts ...services.MarshalOption) ([]types.Server, error) {
...
func (a *ServerWithRoles) GetTokens(opts ...services.MarshalOption) ([]types.ProvisionToken, error) {
