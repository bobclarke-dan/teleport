...
func (c *Client) GetTokens(opts ...services.MarshalOption) ([]types.ProvisionToken, error) {
...
func (c *Client) GetNodes(namespace string, opts ...services.MarshalOption) ([]types.Server, error) {
	if namespace == "" {
		return nil, trace.BadParameter(MissingNamespaceError)
	}
...
type clientProvisioningService interface {
	// GetTokens returns a list of active invitation tokens for nodes and users
	GetTokens(opts ...services.MarshalOption) (tokens []types.ProvisionToken, err error)
